...
install() {
    ...
    if [ -z "$CN" ]; then
        NZ_AGENT_URL="https://proxy.lblog.net/https://${GITHUB_URL}/nezhahq/agent/releases/latest/download/nezha-agent_${os}_${os_arch}.zip"
    else
        ...
        NZ_AGENT_URL="https://proxy.lblog.net/https://${GITHUB_URL}/naibahq/agent/releases/download/${_version}/nezha-agent_${os}_${os_arch}.zip"
    fi
